...
const OAUTH_ERROR_MESSAGES: Record<string, string> = {
  server_error:    'Supabase yapılandırma hatası: Redirect URL izin listesine eklenmemiş.',
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <Suspense fallback={<div className="py-10 text-center text-slate-500">Yükleniyor...</div>}>
          <LoginForm />
        </Suspense>
      </div>
    </div>
